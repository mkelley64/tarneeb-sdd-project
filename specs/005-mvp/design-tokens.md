...
- Do not introduce color, layout, typography, or animation tokens for evaluator
  scoring weights.
- The weak-long-suit regression hand, five-card-trump no-10 regression hand,
  ace-led five-card no-8 regression hand, six-card-trump no-10 regression hand,
  five-card ace-king-queen-ten no-10 regression hand, five-card
  ace-king-queen-jack missing-ten no-10 hand, five-card ace-king-queen
  missing-jack/ten no-9 hand, four-card ace-low no-open-seven hand, five-card
  ace-king-ten missing-queen/jack no-9 hand, five-card ace-queen-ten
  missing-king/jack no-9/no-11 hands, five-card ace-king-jack no-9,
  five-card ace-jack-ten and ace-ten no-open-seven hands, five-card ace-low
  no-8 hand, six-card ace-king-queen missing-jack/ten no-10/no-11/no-12 hands,
  six-card ace-king-queen-jack no-11 hand, five-card king-queen and
  king-queen-ten missing-ace boundaries, six-card ace-jack no-10 hand,
  seven-card ace-queen no-11 hands, eight-card ace-queen-jack-ten no-12 hands,
  shallow trump no-8 hands, short four-card ace-king-ten, ace-king-jack,
  ace-king-jack-ten, ace-king-low, ace-queen-jack, ace-queen-low, and
  ace-jack-ten boundaries including strong-outside-honor ace-king-jack no-10
  cases, and
  partner-awareness pass/raise rules belong in automated bidding tests and
  domain-level recommendation fixtures, not in SwiftUI styling.
...
- When a simulated player passes because their partner is currently highest, the
  ...
  or special visual affordance is introduced for MVP 005.
...
- An all-pass automatic redeal should reuse the existing `animation.deal.*` timing tokens for its fresh deal animation; no separate automatic-redeal timing tokens are introduced for MVP 005.
